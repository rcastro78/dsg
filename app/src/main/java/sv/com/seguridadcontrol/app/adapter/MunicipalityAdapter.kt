...
import sv.com.seguridadcontrol.app.modelos.Mcpty
import java.util.ArrayList

class MunicipalityAdapter (activity: Activity, items: ArrayList<Mcpty>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<Mcpty>? = null
    var item: Mcpty? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.municipio
        return convertView
    }
