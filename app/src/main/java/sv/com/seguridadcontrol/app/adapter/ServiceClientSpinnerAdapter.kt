...
import sv.com.seguridadcontrol.app.modelos.ServiceClientSpr
import java.util.ArrayList

class ServiceClientSpinnerAdapter(activity: Activity, items: ArrayList<ServiceClientSpr>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<ServiceClientSpr>? = null
    var item: ServiceClientSpr? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.servicio + " (id servicio: ${item!!.id_servicio_cliente})"
        return convertView
    }
