...
class SpinnerOrdersTicketAuthAdapter(activity: Activity, items: ArrayList<OrdenesTicket>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<OrdenesTicket>? = null
    var item: OrdenesTicket? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.order_num
        return convertView
    }
