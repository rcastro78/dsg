...
import sv.com.seguridadcontrol.app.modelos.Ctry
import java.util.ArrayList

class PaisSpinnerAdapter(activity: Activity, items: ArrayList<Ctry>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<Ctry>? = null
    var item: Ctry? = null
