...
import sv.com.seguridadcontrol.app.modelos.BranchSpr

import java.util.ArrayList

class BranchSpinnerAdapter (activity: Activity, items: ArrayList<BranchSpr>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<BranchSpr>? = null
    var item: BranchSpr? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.nombre_comercial
        return convertView
    }
