...
import sv.com.seguridadcontrol.app.modelos.AdviserData
import java.util.ArrayList

class AdvisersSpinnerAdapter (activity: Activity, items: ArrayList<AdviserData>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<AdviserData>? = null
    var item: AdviserData? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.nombre_empleado+" "+item!!.apellido_empleado
        return convertView
    }
