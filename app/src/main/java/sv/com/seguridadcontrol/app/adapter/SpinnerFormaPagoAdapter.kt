...
class SpinnerFormaPagoAdapter (activity: Activity, items: ArrayList<FormaPago>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<FormaPago>? = null
    var item: FormaPago? = null
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        holder.lblItem!!.text = item!!.forma
        return convertView
    }
