...
class ProspectClientSprAdapter (activity: Activity, items: ArrayList<ProspectClientSpr>?) : BaseAdapter() {
    var activity: Activity? = null
    var items: ArrayList<ProspectClientSpr>? = null
    var item: ProspectClientSpr? = null
